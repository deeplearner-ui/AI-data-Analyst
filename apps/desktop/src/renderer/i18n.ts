...
const messages = {
  "zh-CN": {
    ...
    assistant: "分析助手", assistantTagline: "计划先行 · 本地执行", assistantNote: "我只会将字段结构、统计摘要和脱敏样例发送给模型。完整数据不会离开本机。",
    ...
    privacyPreview: "隐私预览", privacyNote: "模型上下文可在生成计划前通过 API 检查；文本单元格仅显示长度占位符。",
  ...
  en: {
    ...
    assistant: "Analysis Assistant", assistantTagline: "Plan first · Run locally", assistantNote: "Only field structure, statistical summaries, and masked samples are sent to the model. Complete data never leaves this device.",
    ...
    privacyPreview: "Privacy preview", privacyNote: "Model context can be inspected through the API before plan generation; text cells appear only as length placeholders.",
